...
files_eval = [
    ...
    ["../input_data/eval_data1.csv", "../input_data/eval_data2.csv"],
    [
        "../input_data/cat_eval_data1.csv",
        "../input_data/cat_eval_data2.csv",
        "../input_data/cat_eval_data3.csv",
    ],
    [
        "../input_data/cont_eval_data1.csv",
        "../input_data/cont_eval_data2.csv",
        "../input_data/cont_eval_data3.csv",
    ],
    [
        "../input_data/cont_eval_data1.csv",
        "../input_data/cont_eval_data2.csv",
...
files_debug = [
    [
        "../input_data/debug_data1.csv",
        "../input_data/debug_data2.csv",
        "../input_data/debug_data3.csv",
    ],
    [
        "../input_data/debug_data1.csv",
        "../input_data/debug_data2.csv",
    ...
    [
        "../input_data/cat_debug_data1.csv",
        "../input_data/cat_debug_data2.csv",
        "../input_data/cat_debug_data3.csv",
    ],
    [
        "../input_data/cont_debug_data1.csv",
        "../input_data/cont_debug_data2.csv",
        "../input_data/cont_debug_data3.csv",
    ],
    [
        "../input_data/cont_debug_data1.csv",
        "../input_data/cont_debug_data2.csv",
...
def exercice4(files_to_study, **tree_params):
    ...
    for file in files_to_study:
        ...
        current_tree = Tree(
            features[:training_nb], labels[:training_nb], types, **tree_params
        )
...
def exercice7(files_to_study):
    ...
    for file in files_to_study:
        ...
        ps_instance = PointSet(features, labels, types)
        results += [
            list(ps_instance.get_best_gain()) + [ps_instance.get_best_threshold()]
        ]
    return results
